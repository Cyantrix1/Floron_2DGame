...
public class UI {
    ...
    BufferedImage heart_full, heart_half, empty_heart, crystal_full, crystal_blank, coin;
    ...
    public void drawInventory(Entity entity, boolean cursor){
        ...
        if(entity==gp.player){
            ...
            frameWidth = gp.tileSize*6;
            frameHeight = gp.tileSize*5;
            slotCol = traderSlotCol;
            slotRow = traderSlotRow;
        }
    ...
    public void tradeSelect(){
        ...
        if(commandNum ==2){
            ...
            if(gp.keyH.enterPressed == true){
               ...
               currentDialogue = "Please come again!";
            }
        }
    ...
    public void tradeBuy(){
        ...
        // DRAW PRICE WINDOW
        int itemIndex = getItemIndexOnSlot(traderSlotCol,traderSlotRow);
        if(itemIndex < trader.inventory.size()){
            ...
            if(gp.keyH.enterPressed == true){
                if(trader.inventory.get(itemIndex).price > gp.player.coin){
                    subState = 0;
                    gp.gameState = gp.dialogueState;
                    currentDialogue = "Not Enough MONEY!!!";
                    drawDialogueScreen();
                }
                else{
                    if(gp.player.canObtainItem(trader.inventory.get(itemIndex)) == true){
                        gp.player.coin -= trader.inventory.get(itemIndex).price;
                    }
                    else{
                        subState =0;
                        gp.gameState = gp.dialogueState;
                        currentDialogue = "Not Enough SPACE!!!!";
                    }
                }
            }
        }
